...
public class GestorAlumnoTest {
	...
	public void agregar_alumnoAEscuela() {
		...
		alumnoService.guardarDireccion(direccion);
		// ----Creamos alumno
		Alumno alumno1 = new Alumno("Ariel", "ChorVoyalEscuela", "Chile", "395783489", "Ariel@gmail.com", "+543536458203",
				"2039822669840", fechaNacimiento, "4to", Turno.Tarde, null, direccion, null);
	...
	/*
	 * @Test void agregar_grupoFamiliarAAlumno() { // Fecha de nacimiento Calendar
	 * fecha1 = Calendar.getInstance(); fecha1.set(2003, 6, 3); Date fechaNacimiento
	 * = fecha1.getTime(); // Direccion Direccion direccion = new
	 * Direccion("Ramirez 896", "Lucas Gonzalez", "3158");
	 * alumnoService.guardarDireccion(direccion); // ----Creamos alumno Alumno
	 * alumno1 = new Alumno("Camila", "Palermo", "Argentina", "395783489",
	 * "CamilaPale@gmail.com", "+543536458203", "2039822669840", fechaNacimiento,
	 * "4to", Turno.Tarde, null, direccion, null);
	 * 
	 * Optional<Alumno> optAlumno = alumnoService.guardarAlumno(alumno1); //
	 * ------------------------Creo grupo familiar GrupoFamiliar grupoFamiliar = new
	 * GrupoFamiliar(); // Progenitor ProgenitorTutor progenitor = new
	 * ProgenitorTutor("Don Juan", "Palermo", 100000.00, 55, "Pule pisos",
	 * "Oficina", true, grupoFamiliar);
	 * grupoFamiliar.addProgenitorTutor(progenitor); // Hermanos Hermano h1 = new
	 * Hermano(25, "Pule picaportes", "", true, grupoFamiliar); Hermano h2 = new
	 * Hermano(20, "Pule picaportes", "", true, grupoFamiliar); Hermano h3 = new
	 * Hermano(14, "", "Escuela sin nombre", true, grupoFamiliar);
	 * grupoFamiliar.addHermano(h1); grupoFamiliar.addHermano(h2);
	 * grupoFamiliar.addHermano(h3); // EnfermedadCronica EnfermedadCronica
	 * enfermedadCronica1 = new EnfermedadCronica("Hipertension", 5000.00,
	 * grupoFamiliar); grupoFamiliar.addEnfermedadCronica(enfermedadCronica1); //
	 * Guardamos el grupo familiar
	 * alumnoService.guardarGrupoFamiliar(grupoFamiliar); //
	 * --------------------------------------------------------- // Agregamos el
	 * grupo familiar al alumno Optional<Alumno> optAlumnoActualizado =
	 * alumnoService.agregarGrupoFamiliarAAlumno(grupoFamiliar,
	 * optAlumno.get().getId()); assertTrue(optAlumnoActualizado.isPresent());
